...
public:
	 ...
	 */
	std::list<TotalsOfCellsGroup> groupsByCurrentShortcut;
	/**
...
public:
	 ...
	 */
	double getMinimCurrentShortcut (void);
	/**
...
public:
	 ...
	 * according to these values. Then sorts and groups the cells according to their shortcut current.
	 *
...
private:
	 ...
	 */
	void updateGroupsByShortcutCurrent (void);
	/**
	 ...
	 */
	void sortGroupsByShortcutCurrent (void);
	/**
